...
int main() {
    ...
    vector<long long> time(1 << n, INT_MAX), dp(1 << n, INT_MAX), temp(1 << n, INT_MAX);
                    ...
                    for (int p5 = 1; p5 < n + 1; p5++)
                        time[((1 << p1) | (1 << p2) | (1 << p3) | (1 << p4) | (1 << p5)) >> 1] =
                                min(time[((1 << p1) | (1 << p2) | (1 << p3) | (1 << p4) | (1 << p5)) >> 1],
                                    dist[0][p1] + dist[p1][p2] + dist[p2][p3] + dist[p3][p4] +
                                    dist[p4][p5] + dist[p5][n + 1] + 5 * (1 + (p1 != p2) + (p2 != p3) + (p3 != p4) + (p4 != p5)));
