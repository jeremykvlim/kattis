...
int main() {
    ...
    if (!x) {
        cout << 9 * modint::pow(10, k - 1) - modint::pow(9, k);
        exit(0);
    }
    ...
    vector<modint> fact(k + 1, 1), fact_inv(k + 1, 1);
    auto prepare = [&]() {
        auto inv = fact;
    ...
    modint count = 0;
    for (int n8 = 0; n8 <= p2 / 3; n8++)
        for (int n9 = 0; n9 <= p3 / 2; n9++)
            for (int n2_with_4_and_6 = p2 - 3 * n8, n3_with_6 = p3 - 2 * n9, n6 = 0; n6 <= min(n2_with_4_and_6, n3_with_6); n6++)
                for (int n2_with_4 = n2_with_4_and_6 - n6, n3 = n3_with_6 - n6, n4 = 0; n4 <= n2_with_4 / 2; n4++) {
                    int n2 = n2_with_4 - 2 * n4, n1 = k - (n2 + n3 + n4 + p5 + n6 + p7 + n8 + n9);
                    if (n1 >= 0) count += multinomial_coefficient_mod_p(k, {n1, n2, n3, n4, p5, n6, p7, n8, n9}, MOD, fact, fact_inv);
                }
    cout << count;
}
