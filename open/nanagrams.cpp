...
modint ways(unordered_map<long long, vector<long long>> &adj_list, unordered_map<long long, long long> &count, long long s) {
    map<modint, modint> ways_len;
    unordered_map<long long, modint> ways_num{{s, 1}}, digits{{s, 0}};
